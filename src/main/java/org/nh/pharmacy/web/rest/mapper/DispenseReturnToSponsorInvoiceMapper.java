...
public interface DispenseReturnToSponsorInvoiceMapper {
    ...
    @Mappings({
        ...
        @Mapping(target = "sponsorDocument.unit", expression = "java(mapUnit(dispense.getDocument().getReturnUnit()))"),
        ...
        @Mapping(target = "sponsorDocument.roundOff", source = "document.roundOff"),
        @Mapping(target = "sponsorDocument.originalInvoiceNumber", source = "document.invoiceRef.referenceNumber"),
        @Mapping(target = "sponsorDocument.encounter", expression = "java(mapEncounter(dispense.getDocument().getEncounter()))"),
        @Mapping(target = "sponsorDocument.patient", expression = "java(mapPatient(dispense.getDocument().getPatient()))"),
        @Mapping(target = "sponsorDocument.sponsorInvoiceTaxes", expression = "java(convertDispenseReturnTaxToSponsorInvoiceTax(dispense.getDocument().getDispenseTaxes()))"),
        @Mapping(target = "sponsorDocument.sponsorInvoiceItems", expression = "java(convertDispenseReturnItemsToSponsorInvoiceItems(dispense.getDocument().getDispenseReturnDocumentLines()))"),
        @Mapping(target = "sponsorDocument.approvedBy", ignore = true),
        @Mapping(target = "sponsorDocument.partOf", ignore = true)
    })
    SponsorInvoice convertDispenseReturnToSponsorInvoice(DispenseReturn dispense);
    ...
    @Named("dispenseReturnTaxToSponsorInvoiceTax")
    SponsorInvoiceTax mapTaxes(DispenseTax dispenseTax);

    @IterableMapping(qualifiedByName = "dispenseReturnTaxToSponsorInvoiceTax")
    List<SponsorInvoiceTax> convertDispenseReturnTaxToSponsorInvoiceTax(List<DispenseTax> dispenseTaxes);
    ...
    @Mappings({
        ...
        @Mapping(target = "planTaxList", expression = "java(convertDispenseReturnTaxToSponsorInvoiceTax(dispensePlan.getPlanTaxList()))")
    })
    @Named("dispenseReturnPlanToSponsorInvoicePlan")
    SponsorInvoicePlan mapPlans(DispensePlan dispensePlan);

    @IterableMapping(qualifiedByName = "dispenseReturnPlanToSponsorInvoicePlan")
    List<SponsorInvoicePlan> convertDispenseReturnPlanToSponsorInvoicePlan(List<DispensePlan> dispensePlans);

    //Convert Items
    @IterableMapping(qualifiedByName = "convertDispenseReturnItemsSponsorToInvoiceItems")
    List<SponsorInvoiceItem> convertDispenseReturnItemsToSponsorInvoiceItems(List<DispenseReturnDocumentLine> documentLines);
    ...
    @Mappings({
        ...
        @Mapping(target = "consultant", source = "consultant"),
        @Mapping(target = "sponsorInvoiceItemPlans", expression = "java(convertDispenseReturnItemPlansToSponsorInvoiceItemPlans(documentLine.getDispenseItemPlans()))"),
        @Mapping(target = "sponsorInvoiceTaxes", expression = "java(convertDispenseReturnTaxToSponsorInvoiceTax(documentLine.getDispenseTaxes()))")
    })
    @Named("convertDispenseReturnItemsToSponsorInvoiceItems")
    SponsorInvoiceItem convertItem(DispenseReturnDocumentLine documentLine);
    ...
    @Mappings({
        ...
        @Mapping(target = "sponsorPayTax", source = "planRuleDetail.sponsorPayTax"),
        @Mapping(target = "planTaxList", expression = "java(convertDispenseReturnTaxToSponsorInvoiceTax(dispenseItemPlan.getPlanTaxList()))")
    })
    @Named("dispenseReturnItemPlansToSponsorInvoiceItemPlans")
    SponsorInvoiceItemPlan mapItemPlan(DispenseItemPlan dispenseItemPlan);

    @IterableMapping(qualifiedByName = "dispenseReturnItemPlansToSponsorInvoiceItemPlans")
    List<SponsorInvoiceItemPlan> convertDispenseReturnItemPlansToSponsorInvoiceItemPlans(List<DispenseItemPlan> itemPlans);
}

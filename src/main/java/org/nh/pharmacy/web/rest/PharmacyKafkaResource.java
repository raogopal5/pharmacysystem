...
@RestController
@RequestMapping("/api/pharmacy-kafka")
public class PharmacyKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PharmacyKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PharmacyKafkaResource(KafkaProperties kafkaProperties) {
